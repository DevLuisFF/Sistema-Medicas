...
class ConnectionManager
{
	...
	{
		return $this->byId( "citas_medicas_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "citas_medicas_at_localhost";
		$data["connName"] = "citas_medicas at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;citas_medicas;;1"; //currently unused

		$this->_connectionsIdByName["citas_medicas at localhost"] = "citas_medicas_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "citas_medicas";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=citas_medicas;OPTION=3";
		// encription set
		...
		$connectionsData["citas_medicas_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["citas"] = "citas_medicas_at_localhost";
		$connectionsIds["especialidades"] = "citas_medicas_at_localhost";
		$connectionsIds["medicos"] = "citas_medicas_at_localhost";
		$connectionsIds["pacientes"] = "citas_medicas_at_localhost";
		$connectionsIds["admin_rights"] = "citas_medicas_at_localhost";
