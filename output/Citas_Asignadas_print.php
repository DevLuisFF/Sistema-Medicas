...
require_once("include/Citas_Asignadas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "Citas_Asignadas_print";
...
$page_layouts["Citas_Asignadas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Citas Asignadas" );
