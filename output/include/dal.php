...
class tDAL
{
	var $tblcitas_medicas_at_localhost__citas;
	var $tblcitas_medicas_at_localhost__citas_medicas_uggroups;
	var $tblcitas_medicas_at_localhost__citas_medicas_ugmembers;
	var $tblcitas_medicas_at_localhost__citas_medicas_ugrights;
	var $tblcitas_medicas_at_localhost__especialidades;
	var $tblcitas_medicas_at_localhost__medicos;
	var $tblcitas_medicas_at_localhost__pacientes;
	var $tblcitas_medicas_at_localhost__usuarios;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "citas", "varname" => "citas_medicas_at_localhost__citas", "altvarname" => "citas", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "citas_medicas_uggroups", "varname" => "citas_medicas_at_localhost__citas_medicas_uggroups", "altvarname" => "citas_medicas_uggroups", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "citas_medicas_ugmembers", "varname" => "citas_medicas_at_localhost__citas_medicas_ugmembers", "altvarname" => "citas_medicas_ugmembers", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "citas_medicas_ugrights", "varname" => "citas_medicas_at_localhost__citas_medicas_ugrights", "altvarname" => "citas_medicas_ugrights", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "especialidades", "varname" => "citas_medicas_at_localhost__especialidades", "altvarname" => "especialidades", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "medicos", "varname" => "citas_medicas_at_localhost__medicos", "altvarname" => "medicos", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "pacientes", "varname" => "citas_medicas_at_localhost__pacientes", "altvarname" => "pacientes", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		$this->lstTables[] = array("name" => "usuarios", "varname" => "citas_medicas_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
	}
