...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "citas_medicas_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "citas", "varname" => "citas_medicas_at_localhost__citas", "altvarname" => "citas", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "citas_medicas_uggroups", "varname" => "citas_medicas_at_localhost__citas_medicas_uggroups", "altvarname" => "citas_medicas_uggroups", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "citas_medicas_ugmembers", "varname" => "citas_medicas_at_localhost__citas_medicas_ugmembers", "altvarname" => "citas_medicas_ugmembers", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "citas_medicas_ugrights", "varname" => "citas_medicas_at_localhost__citas_medicas_ugrights", "altvarname" => "citas_medicas_ugrights", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "especialidades", "varname" => "citas_medicas_at_localhost__especialidades", "altvarname" => "especialidades", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "medicos", "varname" => "citas_medicas_at_localhost__medicos", "altvarname" => "medicos", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "pacientes", "varname" => "citas_medicas_at_localhost__pacientes", "altvarname" => "pacientes", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "citas_medicas_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "citas_medicas_at_localhost", "schema" => "", "connName" => "citas_medicas at localhost");
		}
	}
